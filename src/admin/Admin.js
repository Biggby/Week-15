  ...
  return (
    <div className="container">
      ...
      <div id="userActions">
        ...
        <button onClick={() => navigate('/delete')} className="btn-block removeuser">
          Go to Remove Page
        </button>
        <button onClick={() => navigate('/add')} className="btn-block adduser">
          Go to Add Page
        </button>
        <button onClick={() => navigate('/get')} className="btn-block userinfo">
          Go to User Info Page
        </button>
        <button onClick={() => navigate('/update')} className="btn-block update">
